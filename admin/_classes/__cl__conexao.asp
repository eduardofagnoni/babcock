...
Class Conexao
	...
	'*************************************************************************
		...
		dataBaseDeDados 	= "babcock"			'Incluir o DataBase
		...
		if tipoDeAmbiente="local" then	
			...
			nomeDoSistema				=	"Babcock"
			caminhoInicial				=	"http://localhost/babcock"
			caminhoFisico				=	"C:\Users\eduardo\OneDrive - Brancozulu Publicidade Comunicacao e educacao ltda\__TrabalhosBrancozulu\26-babcock\guideline\"
			prefixoTabela				=	"_dev_"
			...
			upSelos						=	caminhoFisico+"admin\__media\selos"
			upServicos					=	caminhoFisico+"admin\__media\servicos"
			...
			enderecoSelos				=	caminhoInicial+"/admin/__media/selos/"
			enderecoServicos			=	caminhoInicial+"/admin/__media/servicos/"
