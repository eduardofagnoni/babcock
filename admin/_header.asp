<header class="main-header">
    ...
    <span class="logo-mini"><img src="../images/logo-babcock.png" alt="Norsal" title="Norsal" style="height:45px"></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img src="../images/logo-m-babcock.png" alt="Norsal" title="Norsal"></span>
    </a>
