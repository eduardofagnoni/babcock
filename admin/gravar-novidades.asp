...
oConexaoAdd.UpdateItem("UPDATE "&oConexaoAdd.prefixoTabela&"novidades SET nome='"&varNome&"',resumo='"&varResumo&"',texto='"&varTexto&"',dataProjeto='"&varDataProjeto&"',registroIncluido='"&varRegistroIncluido&"',regTerminado='"&varRegistroTerminado&"',ultimaAlteracao='"&ultima_alteracao&"' WHERE id="&varIdProjeto)
