...
<main>
    ...
    <section id="topos-internos" class="topo-o-que-fazemos"></section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-7">
                    <ul>
                        <li><p>Infraestrutura única e treinamento especializado.</p></li>
                        <li><p>Suporte de engenharia sob medida e altamente qualificado.</p></li>
                    </ul>
                </div>
            </div>
        </div>
