        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-5">
                    <div class="col-1">
                        <h1>Manutencão em<br> Classe Mundial</h1>
                    </div>
                </div>
                <div class="col-xs-12 col-md-7">
                    <ul>
                        <li><p>Estamos capacitados para atuar em qualquer estratégia e em todas as especialidades, com Manutenção, Gerenciamento e Soluções para infraestruturas.</p></li>
                    </ul>
                </div>
            </div>            
        </div>
